<template>
    <div id="app">
      ...
      <b-button class="buttonn" pack="fas" icon-right="file-import" expanded  @click="sendXCM($store.state.account)">Send transaction</b-button>
    
      <p style="margin-top: 5% "> Your recent transactions: </p>
